			...
			meta={[
				{
					name: 'keywords',
					content:
						'paweł tylek, pawel tylek, ptylek, frontend, front-end, magento, dev, developer, kraków',
				},
				{
					name: 'description',
					content:
						'Frontend and Certified Magento 2 developer based in Cracow, PL.',
				},
				...
				},
				{
					...
					content: 'wSIJ9WlT_uhwOy3Q54cQMPURXfs8YtOG1qrOr7GLqvg',
				},
				{
					property: 'og:title',
					content: 'Pawel Tylek - frontend developer',
				},
				{
				...
				{
					property: 'og:image',
					content: '/assets/favicons/logo-og.png',
				},
				{
